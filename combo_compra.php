                                                    ...
                                                    <div class="row g-0">
                                                        ...
                                                        <div class="col-md-8">
                                                                ...
                                                                <h6>Información</h6>
                                                                    <hr class="mt-0 mb-4">
                                                                        ...
                                                                        <div class="col-6 mb-3">
                                                                            <h6>Partido</h6>
                                                                                <p class="text-muted">
                                                                                Con este pase podés elegir un partido por instancia y funciona como si hubieras comprado un ticket por instancia
                                                                                </p>
                                                                        </div>
                                                            <div class="col-6 mb-3">
                                                            ...
                                                            <div class="col-6 mb-3">
                                                                <h6>Precio ticket</h6>
                                                                <p class="text-muted">
                                                                $ '.$row["precio"].' USD <span class="text-success fw-bold">10% off</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </div>
